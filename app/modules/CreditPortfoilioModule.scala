...
import models.services.{MailService, UserService, UserServiceImpl}
 ...
 */
class CreditPortfoilioModule extends AbstractModule with ScalaModule {
  ...
  def configure() {
    ...
    bind[MailService].to[MailService.Default]
    bind[CreditDAO].to[CreditDAOImpl]
  }
